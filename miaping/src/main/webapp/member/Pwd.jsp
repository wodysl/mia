...
<head>
  ...
  <link rel="stylesheet" href="../css/member/Pwd.css">
  ...
  <div class="big"><form action="">
    <div class="imgBox">
      ...
      <div class="small">
        ...
        <input type="text" onblur="this.placeholder='비밀번호를 찾고자하는 아이디'" onfocus="this.placeholder='비밀번호를 찾고자하는 아이디'" placeholder="비밀번호를 찾고자하는 아이디" id="id"><br>
